...
namespace ViMagento\VipPoint\Setup\Patch\Data;
...
class AddCustomerAttribute implements DataPatchInterface
{
    ...
    public function apply()
    {
        ...
        $customerSetup->addAttribute(Customer::ENTITY, 'vip_point', [
            'type' => 'varchar',
            'input' => 'text',
            'label' => 'Vip Point',
            'required' => true,
        ...
        $newAttribute = $this->eavConfig->getAttribute(Customer::ENTITY, 'vip_point');
